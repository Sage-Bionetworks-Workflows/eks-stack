...
import {
  to = module.sage-aws-ses.aws_ses_email_identity.identities["aws-dpe-dev@sagebase.org"]
  id = "aws-dpe-dev@sagebase.org"
}

import {
  to = module.sage-aws-ses.aws_ses_email_identity.identities["bryan.fauble@sagebase.org"]
  id = "bryan.fauble@sagebase.org"
}

import {
  to = module.sage-aws-ses.aws_ses_domain_identity.identities["sagebase.org"]
  id = "sagebase.org"
}
